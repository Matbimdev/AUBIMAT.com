...
(function () {
  ...
  const translations = {
    ...
    en: {
      ...
      // Pricing
      price_badge: "Pricing",
      price_title: "The whole catalogue, <span class=\"text-brand-cyan\">the plan that suits you</span>",
      price_desc: "My best tools for every discipline, on whichever billing cycle suits you. No per-tool licences and nothing more to pay when a new Revit version lands.",

      plan_monthly_name: "Monthly",
      plan_monthly_amount: "9.99",
      plan_monthly_period: "/month",
      plan_monthly_sub: "Billed every month. Cancel from your own account whenever you like.",

      plan_semiannual_name: "6 months",
      plan_semiannual_amount: "54.99",
      plan_semiannual_period: "/6 months",
      plan_semiannual_sub: "Billed twice a year. Works out at $9.17 a month.",
      plan_semiannual_save: "Save $4.95",

      plan_annual_name: "Yearly",
      plan_annual_amount: "99.99",
      plan_annual_period: "/year",
      plan_annual_sub: "Billed once a year. Works out at $8.33 a month.",
    ...
    es: {
      ...
      // Precios
      price_badge: "Precios",
      price_title: "Todo el catálogo, <span class=\"text-brand-cyan\">el plan que te convenga</span>",
      price_desc: "Mis mejores herramientas para cada disciplina, con el ciclo de cobro que prefieras. Sin licencias por herramienta y sin volver a pagar cuando salga una nueva versión de Revit.",

      plan_monthly_name: "Mensual",
      plan_monthly_amount: "9.99",
      plan_monthly_period: "/mes",
      plan_monthly_sub: "Se cobra cada mes. Cancela desde tu propia cuenta cuando quieras.",

      plan_semiannual_name: "6 meses",
      plan_semiannual_amount: "54.99",
      plan_semiannual_period: "/6 meses",
      plan_semiannual_sub: "Se cobra dos veces al año. Sale a $9.17 al mes.",
      plan_semiannual_save: "Ahorras $4.95",

      plan_annual_name: "Anual",
      plan_annual_amount: "99.99",
      plan_annual_period: "/año",
      plan_annual_sub: "Se cobra una vez al año. Sale a $8.33 al mes.",
      ...
      subj_other: "Otros",
      form_message: "Cuéntame qué quieres automatizar",
      form_send: "Enviar",
